...
function dashboardTemplate() {
  ...
  return `<section class="admin-heading"><div><p class="eyebrow">Owner dashboard</p><h1>Good to see you.</h1><p>${escapeHtml(state.user.email || 'Owner account')}</p></div><div class="admin-heading-actions"><a class="button button--secondary" href="index.html" target="_blank" rel="noopener">View shop</a><button class="text-button" type="button" data-owner-sign-out>Sign out</button></div></section>
